...
class DashBoardEngaged extends StatefulWidget {
  DashBoardEngaged({super.key});

  List<Color> get availableColors => <Color>[
        PicmeColors.mainColor,
        PicmeColors.grayBlack,
        PicmeColors.grayBlack,
        PicmeColors.mainColor,
        PicmeColors.grayBlack,
  ...
  @override
  State<StatefulWidget> createState() => DashBoardEngagedState();
}

class DashBoardEngagedState extends State<DashBoardEngaged> {
      ...
      barRods: [
        BarChartRodData(
          ...
          borderSide: isTouched
              ...
              : BorderSide(color: PicmeColors.grayWhite, width: 0),
